...
<html>
<head>
    <title><?php echo _ActivationCode?></title>
<meta charset="UTF-8">
    ...
    <div class="container-login100" >
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form class="login100-form validate-form" action="#" method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="<?php echo _enterNewPass?>">
                    <span class="label-input100"><?php echo _NewPass?></span>
                    <input class="input100" type="password" name="pass" id="pass" placeholder="<?php echo _NewPass?>">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
                <div class="wrap-input100 validate-input" data-validate="<?php echo _EnterCode?>">
                    <span class="label-input100"><?php echo _EnterCode?></span>
                    <input class="input100" type="password" name="pass" id="pass" placeholder="<?php echo _EnterCode?>">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
