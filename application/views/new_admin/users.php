        ...
        <div class="box-body">
            <table id="table" class="table table-striped table-hover dt-responsive display nowrap" width="100%"
                ...
                <tr>
                    ...
                    <th style="text-align: center;">الحد الأعظم للمنتجات</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.update', function () {
        ...
        $("#wait").show();
        $.ajax({
            url: "<?=base_url('MemberArea/get_data_user')?>",
            method: "post",
            data: {id: user_id},
            dataType: 'json',
            success: function (data) {
                $("#changeMaxProduct").val(data.u_max_product);
                $("#form-change").show();
                $("#wait").hide();
                $("#changeState").val(data.active);
            }
        });
    });
