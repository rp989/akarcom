                    ...
                    <div class="navbar navbar-nobg">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a class="smoth-scroll" href="<?php echo base_url(); ?>"><?php echo $this->lang->line('Home');?>
...
<div class="single-blogarea section-padding">
    <div class="container">
        <div class="row">
            <div class="product-box col-md-8">
                <div class="inner-box">
                    <div class="">
                        <!--start-->
                                    ...
                                    <div class="product-title text-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="overview">
                                                ...
                                                <ul>
                                                    <li><b><?php echo $this->lang->line('price');?></b><span><?php echo $post['priceOfMeter'];?></span></li>
            ...
            <div class="col-sm-12 text-center">
                <div class="footer-short-desc">
                    <p class="text-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        Lorem Ipsum has been the industry's standard dummy text ever since. Lorem Ipsum is simply dummy
