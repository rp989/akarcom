...
<!-- Mirrored from demo.dueza.com/property-html/property/black-color/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Oct 2018 17:43:17 GMT -->
<head>
    <!-- META -->
    <meta charset="utf-8">
...
<div class="single-blogarea section-padding" style="    padding-top: 20px;">
    <div class="row" style="margin-right: 0;">
        ...
        <div class="col-md-9 wow fadeInUp" style="padding-right: 30px;" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
            <div class="recent-post single-sidebar" style="text-align: center;">

                <?php
                if (is_array($posts)) {
                    foreach ($posts as $key => $post) { ?>
                        <!-- START SINGLE PRODUCT ITEM -->
                        <div class="product-box col-md-4 col-sm-4 col-xs-4" style="    float: right;">
                            <div class="inner-box">
                                <div class="image-box">
        ...
        <div class="col-md-2 filters offset-0">
...
<footer class="footer-area wow fadeInUp" id="contact" data-wow-delay="1s">
    <div class="container">
        <div class="row">
