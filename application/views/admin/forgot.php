    ...
    <div class="container-login100" >
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form" action="#" method="post">
                <div class="wrap-input100 validate-input m-b-23" data-validate = "<?php echo _FullNameEnter?>">
                    <span class="label-input100"><?php echo _FullName ?></span>
                    <input class="input100" type="text" name="name" id="username" placeholder="<?php echo _FullName ?>">
                ...
                <div class="text-left p-t-8 p-b-31">
                    <a href="<?php echo base_url();?>CodeActivation" style="cursor: pointer;float: left;">
                        <?php echo _EnterCode;?>
                    </a>
                    <a href="<?php echo base_url();?>SignIn" style="cursor: pointer;float: right;">
                        <?php echo _logIn;?>
                    </a>
                </div>
