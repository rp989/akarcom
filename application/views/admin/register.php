    ...
    <div class="container-login100" >
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form class="login100-form validate-form" action="#" method="post">
                <div class="wrap-input100 validate-input m-b-23" data-validate = "<?php echo _FullName ?>">
                    <span class="label-input100"><?php echo _FullName ?></span>
                    <input class="input100" type="text" name="name" id="username" placeholder="<?php echo _FullName ?>" required>
                ...
                <div class="wrap-input100 validate-input" data-validate="<?php echo _reEnterPass?>">
                    <span class="label-input100"><?php echo _reEnterPass?></span>
                    <input class="input100" type="password" name="pass" id="pass" placeholder="<?php echo _reEnterPass?>">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
