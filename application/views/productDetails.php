                        ...
                        <div class="pagecontainer3 offset-0">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                <li onclick="mySelectUpdate()" class="active"><a data-toggle="tab" href="#summary"><span
                                                ...
                                                class="hidetext"><?php echo $this->lang->line('information'); ?></span>&nbsp;</a>
                                </li>
                                <li onclick="loadScript()" class=""><a data-toggle="tab" href="#maps"><span
                                                class="maps"></span><span
                                                class="hidetext"><?php echo $this->lang->line('Maps'); ?></span>&nbsp;</a>
                                </li>
                            </ul>
                                ...
                                <div id="summary" class="tab-pane active fade in">
                                    <div class="product-title text-center">
                                        ...
                                        <div class="location"><span
                                                    class="fa fa-map-marker"></span>&nbsp;<?php echo $post['address']; ?>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="overview">
                                                ...
                                                <ul>
                                                    <li>
                                                        <b><?php echo $this->lang->line('price'); ?></b><span><?php echo $post['priceOfMeter']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('properties'); ?></b><span><?php echo $post['typeOfProperty']['name']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('type'); ?></b><span><?php echo $post['type']['name']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('cladding'); ?></b><span><?php echo $post['typeOfCladding']['name']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('numbrsOfRooms'); ?></b><span><?php echo $post['numOfRooms']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('BATHROOMS'); ?></b><span><?php echo $post['numOfBathRooms']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('floor'); ?></b><span><?php echo $post['floor']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('parking'); ?></b><span><?php echo $post['parking'] != 'false' ? 'يوجد' : 'لا يوجد'; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('interphone'); ?></b><span><?php echo $post['interphone'] != 'false' ? 'يوجد' : 'لا يوجد'; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('elevator'); ?></b><span><?php echo $post['elevator'] != 'false' ? 'يوجد' : 'لا يوجد'; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('AREA'); ?></b><span><?php echo $post['areaSpace']; ?></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="overview">
                                                ...
                                                <ul>
                                                    <li>
                                                        <b><?php echo $this->lang->line('winter'); ?></b><span><?php echo $post['winter']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('summer'); ?></b><span><?php echo $post['summer']; ?></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="overview">
                                                ...
                                                <ul>
                                                    <li>
                                                        <b><?php echo $this->lang->line('Name'); ?></b><span><?php echo $post['name']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b><?php echo $this->lang->line('GSM'); ?></b><span><?php echo $post['gsm']; ?></span>
                                                    </li>
                                                    <li>
                                                        <b>وقت الاعلان</b><span><?php echo $post['timestamp']; ?></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="product-box col-md-12 col-sm-12 col-xs-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="product-price"><?php echo ' (' . $post['areaSpace'] . ') '; ?></div>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <div class="view-etails-btn clearfix">
                                        <div class="link-box"><a
                                                    ...
                                                    class="theme-btn"><?php echo $this->lang->line('View_Details'); ?>
