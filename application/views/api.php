...
<body>
<h2>Real Estate API For Mobile Application</h2>
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive" data-pattern="priority-columns">
                <table summary="This table shows how to create responsive tables using RWD-Table-Patterns' functionality"
                    ...
                    <caption class="text-center">Base URL: <a href="https://www.nayotex-technologies.com/realEstate"
                                                              target="_blank">https://www.akarcom.app/Authentication/</a><p style="color: brown;display: initial;">URL</p>
                    </caption>
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th data-priority="1">Method</th>
                        <th style="color: brown;" data-priority="2">URL</th>
                        <th data-priority="3">Parameters (as json)</th>
                        <th data-priority="4">Headers</th>
                    ...
                    <tr>
                        ...
                        <td>Register</td>
                        <td>name [String],
                            gsm [String] (start with "09"),
                            password [String],
                            birthday [Y-M-D]
                        </td>
                        <td>Authorization & OS & appVersion</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Login</td>
                        <td>POST</td>
                        <td>Login</td>
                        <td>gsm [String](start with "09"),
                            password[String]
                        </td>
                        <td>Authorization & OS & appVersion</td>
                        <td>must account be activated for success login</td>
                    </tr>
                    <tr>
                        <td>Activation Account</td>
                        <td>POST</td>
                        <td>activationAccount</td>
                        <td>gsm [String](start with "09"),
                            code [String] (look like XXX-XXX)
                        </td>
                        <td>Authorization & OS & appVersion</td>
                        <td>after register must user activate his number by sms code</td>
                    </tr>
                    <tr>
                        <td>Forgot Account</td>
                        <td>POST</td>
                        <td>forgotAccount</td>
                        <td>gsm [String](start with "09")</td>
                        <td>Authorization & OS & appVersion</td>
                        <td>if user forgot password</td>
                    </tr>
                    <tr>
                        <td>Code Forgot Account</td>
                        <td>POST</td>
                        <td>codeForgotAccount</td>
                        <td>gsm [String](start with "09"),
                            newPassword [String],
                            code [String] (look like XXX-XXX)
                        </td>
                        <td>Authorization & OS & appVersion</td>
                        <td>after request Forgot password user must enter code received as SMS</td>
                    </tr>
                    <tr>
                        <td>Logout</td>
                        <td>GET</td>
                        <td>Logout</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>User Profile</td>
                        <td>GET</td>
                        <td>getProfileOfUser</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>User Change Profile</td>
                        <td>POST</td>
                        <td>updateProfileOfUser</td>
                        <td>gsm [String](start with "09"),
                            name [String]
                        </td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td>if user change her GSM you will received error code -999</td>
                    </tr>
                    <tr>
                        <td>User Change Password</td>
                        <td>POST</td>
                        <td>ChangePassword</td>
                        <td>oldPassword [String],
                            newPassword [String]
                        </td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td></td>
                ...
                <table summary="This table shows how to create responsive tables using RWD-Table-Patterns' functionality"
                       class="table table-bordered table-hover">
                    <caption class="text-center">Base URL: <a href="https://www.nayotex-technologies.com/realEstate"
                                                              target="_blank">https://www.akarcom.app/MainScreen/</a><p style="color: brown;display: initial;">URL</p>
                    </caption>
                    <thead>
                    <tr>
                        <th>Name</th>
                    ...
                    <tbody>
                    <tr>
                        <td>Show All Governorates</td>
                        <td>GET</td>
                        <td>GetAllGovernorates</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session(option)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Show Posts</td>
                        <td>POST</td>
                        <td>GetPosts</td>
                        <td>GovernorateId [String],<br>
                            filter [Array] (option)<br>
                            {<br>
                                areaMap [Array]<br>
                                {
                                    topRight [Array] <br>{
                                ...
                                type [Array] (1:sell,2:rent,3:investment<br>
                                             look like: [1,2,3] Or [1,3] Or [2,3]<br>
                                             )<br>
                                typeOf [Array] (1:house,2:villa,3:office,4:Chalet,5:Factory,6:Agricultural Land<br>
                                             look like: [1,3,5,6] Or [4,6] Or [2,5]<br>
                                             )
                            }
                        </td>
                        <td>Authorization & OS & appVersion & session(option)</td>
                    ...
                    <tr>
                        <td>Add Post To My Favorite list</td>
                        <td>POST</td>
                        <td>AddToFavorite</td>
                        <td>PostId [String]</td>
                        <td>Authorization & OS & appVersion & session</td>
                    ...
                    <tr>
                        <td>Get Data for Add Post</td>
                        <td>GET</td>
                        <td>InitializedPost</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td>
                            <strong>
                                ...
                                "cladding": [
                                {
                                "id": "F704F15A-DD2E-41AD-AEB2-13A92122429F",
                                "text": "Property"
                                }
                                ],<br>
                                "tapu": [
                                {
                                "id": "DBF02E00-B7EB-4146-8DE5-DBF9B84487BE",
                                "text": "Agricultural"
                                }
                                ],<br>
                                "properties": [
                                {
                                "id": "7995617B-7D45-40F5-9CB8-1E4B102ABE6E",
                                "text": "residential"
                                }
                                ],<br>
                                "type": [
                                {
                                "id": "FB76F9FA-78C3-4D9C-A3EC-FDB1ED6F090B",
                                "text": "Office"
                                }
                                ],<br>
                                "ownership": [
                                {
                                "id": "010A6B80-26E9-477E-BEDC-E89D0BFA8BA3",
                                "text": "Rent",
                                "period_time": [
                                "1 Month",
                                "3 Month",
                                ...
                                {
                                "id": "7B2A8E04-6679-415A-BBDF-88738220AE63",
                                "text": "Sale"
                                }
                                ],<br>
                                "governorate": [
                                {
                                "id": "7A742620-3E3C-46FC-8136-4D32EB27174F",
                                "name": "damascus"
                                }
                                ]
                                },<br>
                    ...
                    <tr>
                        ...
                        <td>SetPost</td>
                        <td>
                            PathOfPhotos [array of string],
                            Type [String],
                            Address [String],
                            Description [String],
                            NumOfRooms [String],
                            NumOfBathRooms [String],<br>
                            AreaSpace [String],
                            meridian [String],
                            latitude [String],
                            TypeOfProperty [String],
                            TypeOfApartment [String],<br>
                            ...
                            <strong>
                                {
                                "PathOfPhotos":["http://localhost/realEstate/AllPosts","http://localhost/realEstate/AllPosts","http://localhost/realEstate/AllPosts"]
                                "Type":"6D0C22D2-3EF4-4E32-A99F-D5F685C0B651",
                                "DescriptionEn":"test",
                                "DescriptionAr":"تجربة",
                                "AddressEn":"test",<br>
                                "AddressAr":"تجربة",
                                ...
                                "meridian":"36.2783",
                                "latitude":"33.5104",<br>
                                "TypeOfProperty":"7995617B-7D45-40F5-9CB8-1E4B102ABE6E",
                                "DateOfConstruction":"1544788443",
                                "Parking":1,<br>
                                "PriceOfMeter":"23000",
                                "Floor":2,
                                "Elevator":1,
                                "TypeOfCladding":"5A3A1645-24B9-4FC5-AE0E-06CD9BC9BFE3",
                                "Furnished":1,<br>
                                "Interphone":1,
                                "Summer":"test test",
                                "Winter":"test test",
                                "Governorate":"7A742620-3E3C-46FC-8136-4D32EB27174F",
                                "PeriodTime":0,<br>
                                "tapu":"1C11B2F6-9271-4F36-98F9-E4C481BA89A7",
                                "Ownership":"7B2A8E04-6679-415A-BBDF-88738220AE63"
                                }
                            </strong>
                        </td>
                        <td>Authorization & OS & appVersion & session</td>
                        <td>You Must Request Initialized Post</td>
                    </tr>
                    <tr>
                        <td>Add Photo</td>
                        <td>POST</td>
                        ...
                        <td>Authorization & OS & appVersion & session</td>
                        <td>this reqeust must send as (form data) not as Json</td>
                    </tr>
                    <tr>
                        <td>Show All User Posts</td>
                        <td>GET</td>
                        <td>MyPost</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                    ...
                    <tr>
                        <td>Show User Favorite Posts</td>
                        <td>GET</td>
                        <td>MyFavorite</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                    ...
                    <tr>
                        <td>Show All Posts Added Today</td>
                        <td>GET</td>
                        <td>TodayPost</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session</td>
                    ...
                    <tr>
                        <td>Check If Application Latest Version</td>
                        <td>GET</td>
                        <td>CheckForUpdate</td>
                        <td></td>
                        <td>Authorization & OS & appVersion & session(option)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Add Token For Push Notifications</td>
                        <td>POST</td>
                        <td>SetToken</td>
                        <td>Token [String]</td>
                        <td>Authorization & OS & appVersion & session</td>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive" data-pattern="priority-columns">
                <table summary="This table shows how to create responsive tables using RWD-Table-Patterns' functionality"
                       class="table table-bordered table-hover">
                    <caption class="text-center">Headers</caption>
                    <thead>
                    <tr>
                        <th>Name</th>
                    ...
                    <tr>
                        <td>Authorization</td>
                        <td data-priority="1">9CE735A8-4C51-4EAA-945B-8529CAD88441-AEC62DDB-F87C-48F7-9505-12097308F159-EFAB0E00-9220-482C-BF55-C728B42BC1EA-A6346F5C-E48A-4CDC-8962-53CCB9FD53B1-9B0D2802-A46C-41D4-A910-69F828784554-11A02222-2443-44D4-BD5B-EAF64F178094-C33538A5-272C-4E07-8A18-AD56CF1A952F-D4022F9D-AE86-491C-ACCC-AEAD8E96B6B5</td>
                    </tr>
                    <tr>
                        <td>OS</td>
                        <td>"Ios" Or "Android" Or "Web"</td>
                    </tr>
                    <tr>
                        <td>appVersion</td>
                        <td>Start from "1.0"</td>
                    </tr>
                    <tr>
                        <td>session</td>
                        <td>it will geven you after login</td>
                    </tr>
                    <tr>
                        <td>language</td>
                        <td>ar Or en</td>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive" data-pattern="priority-columns">
                <table summary="This table shows how to create responsive tables using RWD-Table-Patterns' functionality"
                       class="table table-bordered table-hover">
                    <caption class="text-center">Errors</caption>
                    <thead>
                    <tr>
                        <th>code</th>
                        <th>response</th>
                    ...
                    <tr>
                        <td>-10</td>
                        <td>Some Data is not set in body of request</td>
                        <td>this error will must show message as alert to users you will get it from result of API</td>
                    </tr>
                    <tr>
                        <td>-11</td>
                        <td>Some Required Data is empty in body of request</td>
                        <td>this error will must show message as alert to users you will get it from result of API</td>
                    </tr>
                    <tr>
                        <td>-13</td>
                    ...
                    <tr>
                        <td>-101</td>
                        <td>Authorization is not correct</td>
                        <td>this error will must show message as alert to users you will get it from result of API</td>
                    </tr>
                    <tr>
                        <td>-403</td>
                        <td>Some Headers is not set in body of request</td>
                        <td>this error will must show message as alert to users you will get it from result of API</td>
                    </tr>
                    <tr>
                        <td>-999</td>
                        <td>something happened</td>
                        <td>in this error you will must logout automatically from application</td>
                    </tr>
                    </tbody>
                </table>
            </div>
