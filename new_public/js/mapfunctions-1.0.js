...
function wpresidence_agency_dev_map(latitude, longitude, map_name) {
    ...
    map = L.map(map_name, {center: mapCenter, zoom: 7,});
...
function wpestate_map_shortcode_function() {
    ...
    if (wp_estate_kind_of_map == 2) {
        ...
        map2 = L.map('googleMap_shortcode', {center: mapCenter, zoom: zoom}).on('load', function (e) {
        ...
        if (jQuery('#googleMap_shortcode').length > 0) {
            ...
            panorama_sh.setPov(({heading: heading, pitch: 0}));
...
function wpestate_createMarker_sh_leaflet(pin_price, infoBox_sh, gmarkers_sh, map2, county_state, size, i, id, lat, lng, pin, title, counter, image, price, single_first_type, single_first_action, link, city, area, rooms, baths, cleanprice, single_first_type_name, single_first_action_name) {
    ...
    infobox += '<div class="info_details ' + infobox_class + '"><a id="infocloser" onClick=\'javascript:jQuery(".leaflet-popup-close-button")[0].click();\' ></a><a href="' + link + '">' + info_image + '</a><a href="' + link + '" id="infobox_title">' + title + '</a><div class="prop_detailsx">' + category_name + " " +   '</div><div class="prop_pricex">' + wpestate_get_price_currency(price, cleanprice) + infosize + infobaths + inforooms + '</div></div>';
    var markerOptions = {riseOnHover: true};
...
function wpestate_createMarker_sh(pin_price, infoBox_sh, gmarkers_sh, map2, county_state, size, i, id, lat, lng, pin, title, counter, image, price, single_first_type, single_first_action, link, city, area, rooms, baths, cleanprice, single_first_type_name, single_first_action_name) {
    ...
    if (mapfunctions_vars.useprice === 'yes') {
        ...
        marker = new WpstateMarker(poss, myLatLng, map2, Titlex, counter, image, id, price2, pin_price, single_first_type, single_first_action, link, i, rooms, baths, cleanprice, size, single_first_type_name, single_first_action_name, pin, infoWindowIndex);
    } else {
...
function wpestate_createMarker(pin_price, size, i, id, lat, lng, pin, title, counter, image, price, single_first_type, single_first_action, link, rooms, baths, cleanprice, single_first_type_name, single_first_action_name) {
    ...
    if (mapfunctions_vars.useprice === 'yes') {
        ...
        var myLatlng = new google.maps.LatLng(lat, lng);
        var marker = new WpstateMarker(poss, myLatlng, map, Titlex, counter, image, id, price2, pin_price, single_first_type, single_first_action, link, i, rooms, baths, cleanprice, size, single_first_type_name, single_first_action_name, pin, i);
    } else {
        infobox_class = " classic_info ";
        var marker = new google.maps.Marker({
            position: myLatLng,
    ...
    google.maps.event.addListener(marker, 'click', function (event) {
        ...
        infoBox.setContent('<div class="info_details ' + infobox_class + '"><span id="infocloser" onClick=\'javascript:infoBox.close();\' ></span><a href="' + this.link + '">' + info_image + '</a><a href="' + this.link + '" id="infobox_title">' + title + '</a><div class="prop_detailsx">' + category_name  + '</div><div class="prop_pricex">' + wpestate_get_price_currency(this.price, this.cleanprice) + infosize + infobaths + inforooms + '</div></div>');
...
function wprentals_draw_leaflet_circle(pos) {
    ...
    var myIcon = L.divIcon({className: 'someclass', iconSize: new L.Point(0, 0), html: wpresidence_leaflet_label});
...
function wpestate_show_pins() {
    ...
    ajaxurl = ajaxcalls_vars.admin_url + 'get-pin';
...
function wpestate_show_pins_custom_search() {
    "use strict";
    var ajaxurl, array_last_item, how_holder, slug_holder, val_holder, position, inserted_val, temp_val, term_id,
        halfmap, newpage, postid, slider_min, slider_max;
    ajaxurl = ajaxcalls_vars.admin_url + 'get-pin';
    inserted_val = 0;
...
/*
function nayotex_map() {
    var governorates = [
        {
            "g_id": "044AA792-BA89-4AB5-8FDA-923B87FA4689",
            "g_name_en": "homs",
            "g_name_ar": "\u062d\u0645\u0635",
            "g_meridian": "36.7234",
            "g_latitude": "34.7268",
            "g_active": "1",
            "g_timestamp": "1544788573"
        },
        {
            "g_id": "0e5f7997-467a-11e9-b042-1c8c6c7814fa",
            "g_name_en": "Tartus",
            "g_name_ar": "\u0637\u0631\u0637\u0648\u0633",
            "g_meridian": "35.8477",
            "g_latitude": "34.886",
            "g_active": "1",
            "g_timestamp": "1544788553"
        },
        {
            "g_id": "0e5f8213-467a-11e9-b042-1c8c6c7814fa",
            "g_name_en": "Hama",
            "g_name_ar": "\u062d\u0645\u0627\u0647",
            "g_meridian": "36.7154",
            "g_latitude": "35.1367",
            "g_active": "1",
            "g_timestamp": "1544788563"
        }, {
            "g_id": "47010E96-C9CA-44D7-9AE8-29FAEC1602E7",
            "g_name_en": "aleppo",
            "g_name_ar": "\u062d\u0644\u0628",
            "g_meridian": "37.1612",
            "g_latitude": "36.2012",
            ...
            "g_id": "7A742620-3E3C-46FC-8136-4D32EB27174F",
            "g_name_en": "damascus",
            "g_name_ar": "\u062f\u0645\u0634\u0642",
            "g_meridian": "36.2783",
            "g_latitude": "33.5104",
            "g_active": "1",
            "g_timestamp": "1544788593"
        }, {
            "g_id": "7abda97c-467a-11e9-b042-1c8c6c7814fa",
            "g_name_en": "Daraa",
            "g_name_ar": "\u062f\u0631\u0639\u0627",
            "g_meridian": "36.0819",
            "g_latitude": "32.6229",
            ...
            "g_id": "7abdb228-467a-11e9-b042-1c8c6c7814fa",
            "g_name_en": "As Suwayda",
            "g_name_ar": "\u0627\u0644\u0633\u0648\u064a\u062f\u0627\u0621",
            "g_meridian": "36.5413",
            "g_latitude": "32.7019",
            "g_active": "1",
            ...
            "g_id": "c79c1199-4679-11e9-b042-1c8c6c7814fa",
            "g_name_en": "Rif Dimashq",
            "g_name_ar": "\u0631\u064a\u0641 \u062f\u0645\u0634\u0642",
            "g_meridian": "36.5799",
            "g_latitude": "33.8137",
            "g_active": "1",
            "g_timestamp": "1544788583"
        }, {
            "g_id": "c79c1b8b-4679-11e9-b042-1c8c6c7814fa",
            "g_name_en": "Latakia",
            "g_name_ar": "\u0627\u0644\u0644\u0627\u0630\u0642\u064a\u0629",
            "g_meridian": "35.7947847",
            "g_latitude": "35.5389465",
            "g_active": "1",
            "g_timestamp": "1544788543"
        }];
    // var data = JSON.parse(governorates);
    var data;
    var new_marker;
    ...
    if (mapfunctions_vars.useprice === 'yes') {
        ...
        var myLatlng = new google.maps.LatLng(lat, lng);
        marker = new WpstateMarker(poss, myLatlng, map, Titlex, counter, image, id, price2, pin_price, single_first_type, single_first_action, link, i, rooms, baths, cleanprice, size, single_first_type_name, single_first_action_name, pin, i);
    } else {
        infobox_class = " classic_info ";
        var marker = new google.maps.Marker({
            position: myLatLng,
    ...
    for (var i = 0; i < governorates.length; i++) {
        var myLatLng = new google.maps.LatLng(governorates[i].g_latitude,governorates[i].g_meridian);
        var Titlex = jQuery('<textarea />').html(governorates[i].g_name_ar).text();
        var poss = 0;
        var infobox_class = " price_infobox ";
        var boxText = document.createElement("div");
        var myOptions = {
...
/*
function nayotex_marker(place_lat, place_lng) {
    "use strict";
    var place_radius;
    if (control_vars.geo_radius_measure === 'miles') {
        place_radius = parseInt(jQuery('#geolocation_radius').val(), 10) * 1609.34;
