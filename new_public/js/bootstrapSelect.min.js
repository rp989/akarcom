...
!function (a) {
    ...
    e.VERSION = "1.6.2", e.DEFAULTS = {
        noneSelectedText: "لم يتم أختيار شي",
        noneResultsText: "غير متواجد",
        ...
        multipleSeparator: ", ",
        style: "wpresidence_button  btn-new",
        size: "auto",
        title: null,
        ...
        constructor: e, init: function () {
            ...
            var b = this.multiple ? " show-tick" : "",
                ...
                h = this.options.actionsBox ? '<div class="bs-actionsbox"><div class="btn-group btn-block"><button class="actions-btn bs-select-all  btn-sm btn-default">' + this.options.selectAllText + '</button><button class="actions-btn bs-deselect-all btn btn-sm btn-default">' + this.options.deselectAllText + "</button></div></div>" : "",
                i = '<div class="btn-group bootstrap-select' + b + c + '"><button type="button" class="btn dropdown-toggle selectpicker' + e + '" data-toggle="dropdown"' + d + '><span class="filter-option pull-left"></span>&nbsp;<span class="caret"></span></button><div class="dropdown-menu open">' + f + g + h + '<ul class="dropdown-menu inner  dropdown-menu filter_menu" role="menu"></ul></div></div>';
            return a(i)
        }, createView: function () {
            ...
            var b = this, d = [], e = 0, f = function (a, b, c) {
                ...
                return '<a tabindex="0"' + ("undefined" != typeof e ? ' class=" new-background ' + e + '"' : "") + ("undefined" != typeof f ? ' style="' + f + '"' : "") + ("undefined" != typeof g ? 'data-optgroup="' + g + '"' : "") + ' data-normalized-text="' + h + '">' + d + '<span class="' + b.options.iconBase + " " + b.options.tickIcon + ' check-mark"></span></a>'
            };
            return this.$element.find("option").each(function () {
                var c = a(this), h = c.attr("class") || "", i = c.attr("style"),
